...
public class ItemEditor extends MinWindowType {

    public Text test;

    public ItemEditor(Group root, Group base, Group topBase, Rectangle background) {
    ...
    public void init() {
        ...
        this.background.setFill(Color.PURPLE);
    ...
    public MinWindowTypeEnum getType() {
        return MinWindowTypeEnum.ItemEditorType;
    }
}
