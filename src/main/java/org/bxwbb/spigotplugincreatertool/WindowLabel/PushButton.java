...
public class PushButton extends BaseLabel implements Button {
    ...
    public PushButton(double startX, double startY, double endX, double endY, BaseLabel baseLabel) {
        this.startX = startX;
        this.startY = startY;
        this.endX = endX;
        this.endY = endY;
        ...
        this.background.addEventHandler(MouseEvent.MOUSE_EXITED, event -> {
            this.background.setFill(this.isDown ? this.downColor : this.baseColor);
